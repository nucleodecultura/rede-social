...
--
-- Banco de dados: `mentesbrilhantes`
--
CREATE DATABASE IF NOT EXISTS `d3f4ltco_mentesbrilhantes` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `d3f4ltco_mentesbrilhantes`;
